...
const TRANSLATIONS = {
  ...
  fr: {
    ...
    'cotizar.estimated': 'Total Estimé',
    ...
    'cotizar.no_catering': 'Sans Restauration (Nourriture/boissons non incluses)',
    'cotizar.no_photo': 'Sans Photographie',
    'cotizar.no_deco': 'Sans Décoration',
    'cotizar.no_recreation': 'Sans Animation',
    'cotizar.success_title': 'Devis Envoyé !',
    'cotizar.success_desc_1': 'Nous avons reçu vos coordonnées. Un conseiller de',
    'cotizar.success_desc_2': 'vous contactera bientôt par WhatsApp ou E-mail pour coordonner les détails.',
    'cotizar.estimated': 'TOTAL ESTIMÉ',
    'cotizar.disclaimer': 'Il s\'agit d\'un devis préliminaire non contraignant. Les serveurs sont calculés automatiquement (1 serveur pour 35 invités).',
